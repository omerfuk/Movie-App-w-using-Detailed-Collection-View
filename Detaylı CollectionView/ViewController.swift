...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let f5 = Filmler(filmId: 5, filmBaslik: "thehatefuleight", filmResimAdi: "thehatefuleight", filmFiyat: 15.99)
        let f6 = Filmler(filmId: 6, filmBaslik: "pianist", filmResimAdi: "thepianist", filmFiyat: 15.99)
...
extension ViewController:UICollectionViewDelegate, UICollectionViewDataSource, FilmHucreProtocol{
    func sepeteEkle(indexPath: IndexPath) {
        ...
        print("Film Sipariş Verildi : \(film.filmBaslik!)")
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let film = filmlerListesi[indexPath.row]
        print("Film Seçildi : \(film.filmBaslik!)")
    }
